...
class VADCollector:
    ...
    def process_audio(
        self, pcm_16_signed_bytes: bytes, silence_threshold_override: int = None
    ):
        """
        ...
        current_silence_threshold = (
            silence_threshold_override
            if silence_threshold_override is not None
            else self.silence_frames_threshold
        )
